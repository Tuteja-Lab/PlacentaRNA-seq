...
e8.5_2 <- read.table(e8.5Files$path[1], header = T)
...
e8.5_3 <- read.table(e8.5Files$path[2], header = T)
...
e8.5_4 <- read.table(e8.5Files$path[3], header = T)
...
e8.5_5 <- read.table(e8.5Files$path[4], header = T)
...
e8.5_6 <- read.table(e8.5Files$path[5], header = T)
...
e9.5_2 <- read.table(e9.5Files$path[1], header = T)
...
e9.5_3 <- read.table(e9.5Files$path[2], header = T)
...
e9.5_4 <- read.table(e9.5Files$path[3], header = T)
...
e9.5_5 <- read.table(e9.5Files$path[4], header = T)
