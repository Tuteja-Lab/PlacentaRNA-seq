...
write.table(linkList2, "Z:/hhvu/Project1_2/RNA-seq/5B_GENIE3/e8.5/e8.5_0.9.txt", row.names = F, quote = F, sep = "\t")
...
write.table(linkList2, "Z:/hhvu/Project1_2/RNA-seq/5B_GENIE3/e9.5/e9.5_0.9.txt", row.names = F, quote = F, sep = "\t")