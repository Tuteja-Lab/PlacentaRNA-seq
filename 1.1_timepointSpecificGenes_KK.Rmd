...
write.table(e8.5specificTrans, "Files/e8.5specific_trans_KK.txt", row.names = F, quote = F)
...
write.table(e8.5specific, "Files/e8.5specific_ensGenes_KK.txt", row.names = F, quote = F)

e8.5TFs <- intersect(e8.5specific, TF_cofactors$V1)
length(e8.5TFs)
#write.table(e8.5TFs, "Files/e8.5specific_TFensGenes.txt", row.names = F, quote = F)
write.table(e8.5TFs, "Files/e8.5specific_TFensGenes_KK.txt", row.names = F, quote = F)
```
...
write.table(e7.5specificTrans, "Files/e7.5specific_trans_KK.txt", row.names = F, quote = F)
...
write.table(e7.5specific, "Files/e7.5specific_ensGenes_KK.txt", row.names = F, quote = F)

e7.5TFs <- intersect(e7.5specific, TF_cofactors$V1)
length(e7.5TFs)
#write.table(e7.5TFs, "Files/e7.5specific_TFensGenes.txt", row.names = F, quote = F)
write.table(e7.5TFs, "Files/e7.5specific_TFensGenes_KK.txt", row.names = F, quote = F)
```
```{r}
#e9.5 specific genes
...
write.table(e9.5specificTrans, "Files/e9.5specific_trans_KK.txt", row.names = F, quote = F)
...
write.table(e9.5specific, "Files/e9.5specific_ensGenes_KK.txt", row.names = F, quote = F)

e9.5TFs <- intersect(e9.5specific, TF_cofactors$V1)
length(e9.5TFs)
#write.table(e9.5TFs, "Files/e9.5specific_TFensGenes.txt", row.names = F, quote = F)
write.table(e9.5TFs, "Files/e9.5specific_TFensGenes_KK.txt", row.names = F, quote = F)

```
```{r}
sink("1.1_sessionInfo.txt")
sessionInfo()
sink()
```