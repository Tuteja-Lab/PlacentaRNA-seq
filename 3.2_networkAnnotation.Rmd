...
randFunc <- function(pop, size, cell, i) {
  ...
  if (cell %in% rownames(res)) {
    p <- res[cell, "Log10PValue"]
  } else {
    p <- 1
  }
...
Example command:
```{BASH, eval=F}
Rscript --vanilla randomizationPCE.R /work/LAS/geetu-lab/hhvu/project1_2/rna-seq/PlacentaRNA-seq/Files/e7.5Group.txt /work/LAS/geetu-lab/hhvu/project1_2/rna-seq/PlacentaRNA-seq/Files/STRING/e7.5/largestComponent/e7.5_1/e7.5_1_nodeTable.csv /work/LAS/geetu-lab/hhvu/project1_2/rna-seq/randomizationPCE/e7.5_1_STRING_EVT_-log10pval.txt "EVT"
```
